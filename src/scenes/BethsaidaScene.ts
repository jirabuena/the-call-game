...
export class BethsaidaScene extends Phaser.Scene {
    ...
    constructor() { super('BethsaidaScene'); }
    ...
    create() {
        ...
        ChapterTitleManager.showTitle(this, 'BethsaidaScene', 'Em desenvolvimento');
    ...
    update() {
        ...
        if (this.player.x > this.cameras.main.width - 5) {
            this.scene.start('UnderFigTreeScene');
        }
