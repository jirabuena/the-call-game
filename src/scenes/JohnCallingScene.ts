...
export class JohnCallingScene extends Phaser.Scene {
    ...
    constructor() { super('JohnCallingScene'); }
    ...
    create() {
        ...
        ChapterTitleManager.showTitle(this, 'JohnCallingScene', 'Em desenvolvimento');
    ...
    update() {
        ...
        if (this.player.x > this.cameras.main.width - 5) {
            this.scene.start('BethsaidaScene');
        }
