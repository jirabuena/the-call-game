...
export class UnderFigTreeScene extends Phaser.Scene {
    ...
    constructor() { super('UnderFigTreeScene'); }
    ...
    create() {
        ...
        ChapterTitleManager.showTitle(this, 'UnderFigTreeScene', 'Em desenvolvimento');
    ...
    update() {
        ...
        if (this.player.x > this.cameras.main.width - 5) {
            this.scene.start('CapernaumTaxScene');
        }
