...
export class ThomasDecisionScene extends Phaser.Scene {
    ...
    constructor() { super('ThomasDecisionScene'); }
    ...
    create() {
        ...
        ChapterTitleManager.showTitle(this, 'ThomasDecisionScene', 'Em desenvolvimento');
    ...
    update() {
        ...
        if (this.player.x > this.cameras.main.width - 5) {
            this.scene.start('JamesAlphaeusScene');
        }
