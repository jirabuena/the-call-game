...
export class JudasIscariotScene extends Phaser.Scene {
    ...
    constructor() { super('JudasIscariotScene'); }
    ...
    create() {
        ...
        ChapterTitleManager.showTitle(this, 'JudasIscariotScene', 'Em desenvolvimento');
